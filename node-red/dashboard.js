...
function login(url, username, password) {
    ...
    if (typeof (element) != 'undefined' && element != null) { //If already login
        ...
        var str = '<iframe id="MyIFrame" width="100%" height="100%" style="border:none;"></iframe>'
        document.body.insertAdjacentHTML('beforebegin', str);

        var button = '<button onclick="apphome()" class="md-raised md-button md-ink-ripple" type="button" aria-label="button" style="color:white; background-color: orange; z-index: 1000; padding: 10px;border-radius: 50%; position: fixed;bottom: 0;right: 0;"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="50"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"></path></svg></button>';
