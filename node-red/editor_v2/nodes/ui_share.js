var ui_share = {
  ...
  load: function (node) {
    ...
    <img 
      style='width:100%;height:100%;opacity: ${opacity};position:absolute;z-index:5;inset:0;touch-action: manipulation !important' 
      class='grid-stack-item-content md-card-img-dummy' 
      src="${editor_host}linhtranvu.github.io/node-red/editor_v2/images/blank.jpg"
    >
