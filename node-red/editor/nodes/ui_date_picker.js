var ui_date_picker = {
  node: /*html*/ `
        ...
        <div
          class="red-ui-palette-node btn-add-node" type="ui_date_picker"
        ...
        >
          ...
          <div
            ...
            data-palette-icon="icons/node-red-dashboard/ui_date_picker.png"
          >
            <div
              class="red-ui-palette-icon"
              style='background-image: url("icons/node-red-dashboard/ui_date_picker.png");'
            ></div>
          </div>
        </div>
...
<md-card ui-card-size="4x1" layout="row" 
    ...
    <md-input-container flex="" layout="row"
        class="grid-stack-item-content md-auto-horizontal-margin md-input-has-placeholder _md-datepicker-floating-label _md-datepicker-has-calendar-icon layout-row flex">
        <!-- ngIf: me.item.label -->
